        ...
        return(<React.Fragment>
            <SafeAreaView style={styles.container}>
                <View style={styles.banner}>
                    <Text style={styles.foretext}>OLINE SHOPPING</Text>
                ...
                <Image style={styles.image} source={require("../assets/images/undraw_shopping_app_flsj.png")}/>
                <TouchableOpacity onPress={this.navigateToCartPage} style={styles.nextbutton}>
                ...
                <View style={styles.footer}>
                    ...
                    <TouchableOpacity onPress={this.skipToExit} style={styles.button}>
